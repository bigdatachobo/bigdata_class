...
def xgb_reg(X_train,y_train,X_test,y_test):
    ...
    #점수 저장 
    global R_svr_xgb, R_svr_xgb, R_svr_xgb
    R_svr_xgb = best_xgb.score(X_test,y_test),
    R_svr_xgb = mean_absolute_error(y_test,y_pred),
    R_svr_xgb = np.sqrt(mean_squared_error(y_test,y_pred))
