...
# 대기 정보
air_co=pd.read_csv('../data/rerefined_data/refined_co.csv',encoding='euc-kr')
air_dust=pd.read_csv('../data/rerefined_data/refined_dust.csv',encoding='euc-kr')
air_no2=pd.read_csv('../data/rerefined_data/refined_no2.csv',encoding='euc-kr')
air_o3=pd.read_csv('../data/rerefined_data/refined_o3.csv',encoding='euc-kr')
air_so2=pd.read_csv('../data/rerefined_data/refined_so2.csv',encoding='euc-kr')
